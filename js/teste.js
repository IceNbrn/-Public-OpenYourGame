var CanvasBG = function (options) {
    ...
    function initHeader(options) {
        ...
        var c = 4;
        // for each point find the c closest points
    ...
    function animate() {
        if(animateHeader) {
            ...
            for(var i in points) {
                var d = 4000 / Math.abs(getDistance(target, points[i]));
                points[i].active = d/3;
                points[i].circle.active = d/2;
                drawLines(points[i]);
    ...
    function drawLines(p) {
        ...
        for(var i in p.closest) {
            ...
            ctx.strokeStyle = 'rgba(126,126,126,'+ p.active+')';
            ctx.stroke();
        }
    }
    ...
    function Circle(pos,rad,color) {
        ...
        this.draw = function() {
            ...
            ctx.fillStyle = 'rgba(126,126,126,'+ _this.active+')';
            ctx.fill();
        };
    }

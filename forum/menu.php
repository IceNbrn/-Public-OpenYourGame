    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="navbar-main">
            <ul class="nav navbar-nav">
                <li class="barrinha">
                    <a class="two" href="../index">
                        Encontrar Jogadores
                    </a>
                </li>
                <li class="active_ice barrinha">
                    <a href="index" class="active_ice">
                        Forum
                    </a>
                </li>
                <li class="barrinha">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown barrinha">
                    ...
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="menu1"><?php if(!isset($_SESSION["userId"])) { echo "Login/Registo";}else{require_once "../includes/database.php"; $database = new DatabaseIcen(); echo "Painel";}?>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="menu1">
                        ...
                        <?php } else { include_once ("../includes/database.php"); $database = new DatabaseIcen(); if($database->isAdmin($_SESSION["userId"]) == 1){?>
                            <li>
                        ...
                        <?php }?>
                            ...
                            <li>
                                <?php include_once ("../includes/database.php"); $db = new DatabaseIcen(); if($db->steamConnection($_SESSION["userId"]) == true){?>
